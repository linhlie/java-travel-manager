...
<html>
	...
	<body id="pageBody">
		...
		<section id="header" class="dark">
			...
			<footer>
				<a href="#download" download="print.js" class="button scrolly">Download v1.0.61</a>
			</footer>
		</section>
				...
				<div class="container" id="download">
					<section>
						...
						<p style="margin-bottom:30px;">
							<a href="https://github.com/crabbly/Print.js/releases/tag/v1.0.61" class="button">Download v1.0.61</a>
						</p>
